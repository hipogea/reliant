...
$this->title = Yii::t('yii2mod.settings', 'Parameters');
$this->params['breadcrumbs'][] = $this->title;
?>

    <h4><span class="fa fa-cog"></span><?php echo Html::encode($this->title); ?></h4>
<div class="box box-success">
    <p><?php echo Html::a(Yii::t('yii2mod.settings', 'Create Setting'), yii\helpers\Url::to(['create-setting','section'=>Yii::$app->controller->module->id]), ['class' => 'btn btn-success']); ?></p>
            ...
            'columns' => [
                ...
                'buttons' => [
                    'update' => function($url, $model) { 
                        $url= yii\helpers\Url::to(['update-setting','id'=>$model->id]);
                        $options = [
                            'title' =>Yii::t('yii2mod.settings', 'Update'), 'data-pjax'=>'0'                                
                        ];
