    ...
    public function behaviors()
{
    ...
    public function attributeLabels()
    {
        return [          
            ...
            'codigo2' => yii::t('base_labels','Universal Code'),            
            'descripcion' => yii::t('base_labels','Description'),
            'marca' => yii::t('base_labels','Manufacturer'),
            'modelo' => yii::t('base_labels','Model'),
            'serie' =>  yii::t('base_labels','Serial'),
            'anofabricacion' => yii::t('base_labels','Year'),
            'codigoitem' => yii::t('base_labels','Item Code'),
           // 'codigocontable' => 'Codigocontable',
            'espadre' => yii::t('base_labels','Has Childs'),
            'lugar_original_id' => yii::t('base_labels','Original Place'),
            'tipo' => yii::t('base_labels','Type'),
            'codarea' => yii::t('base_labels','Departament'),
            'codestado' => yii::t('base_labels','Status'),
            'lugar_id' => yii::t('base_labels','Place'),
            'fecha' => yii::t('base_labels','Date'),
            'codocu' => yii::t('base_labels','Document'),
            'numdoc' => yii::t('base_labels','Doc Number'),
            'entransporte' => yii::t('base_labels','In Transport'),
        ];
    }
