...
class Module extends \yii\base\Module
{
   ...
   public static function getId(){
    ...
    {
        \Yii::$app->i18n->translations['modules/bigitems/*'] = [
            'class' => 'yii\i18n\PhpMessageSource',
            'sourceLanguage' => 'en-US',
            'basePath' => '@frontend/modules/bigitems/messages',
            'fileMap' => [
                'modules/bigitems/verbs' => 'verbs.php',
                'modules/bigitems/validaciones' => 'validaciones.php',
                'modules/bigitems/labels' => 'labels.php',
    ...
    public static function t($category, $message, $params = [], $language = null)
    {
        ...
        return Yii::t('modules/bigitems/' . $category, $message, $params, $language);
    }
