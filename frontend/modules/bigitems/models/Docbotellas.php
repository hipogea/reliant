   ...
   public $codocu='478';
    ...
    public function attributeLabels()
    {
        return [
            ...
            'codenvio' => Yii::t('base_labels', 'Codenvio'),
            'fecdocu' => Yii::t('base_labels', 'Fecdocu'),
            'fectran' => Yii::t('base_labels', 'Fectran'),
            'codtra' => Yii::t('base_labels', 'Codtra'),
            'codven' => Yii::t('base_labels', 'Codven'),
            'codplaca' => Yii::t('base_labels', 'Codplaca'),
