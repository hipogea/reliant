...
<?php
$url= Url::to(['/maestros/clipro/createcontact','id'=>$model->codpro,'gridName'=>'grilla-contactos','idModal'=>'buscarvalor']);
 
  echo  Html::button('<span class="fa fa-user"></span>'.m::t('base_verbs','Create contact'), ['href' => $url, 'title' =>m::t('verbs','New contact').'   '.$model->despro,'id'=>'btn_contacts', 'class' => 'botonAbre btn btn-success']); 
