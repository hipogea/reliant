...
*/
    ...
    public function actionUpdate($id) {
        ...
        $searchModel = new  \common\models\masters\MaestrocliproSearch();
    ...
    public function actionCreatecontact($id) {
        ...
        if ($model->load(Yii::$app->request->post()) && $model->save()) {
            ...
            return $this->renderAjax('/contactos/create', [
                        'model' => $model,
                        'id' => $id,
            ...
            return $this->render('/contactos/create', [
                        'model' => $model,
                        'vendorsForCombo' => $vendorsForCombo,
            ]);
        }
    ...
    public function actionCreateaddresses($id) {
        ...
        if ($model->load(Yii::$app->request->post()) && $model->save()) {
            ...
            return $this->renderAjax('/direcciones/create', [
                        'model' => $model,
                        'id' => $id,
                            //'vendorsForCombo'=>  $vendorsForCombo,
                            //'aditionalParams'=>$aditionalParams
            ...
            $vendorsForCombo = h::getCboClipros();
            return $this->render('/direcciones/create', [
                        'model' => $model,
                        //'vendorsForCombo' => $vendorsForCombo,
            ]);
        }
