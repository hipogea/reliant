...
class Clipro extends \common\models\base\modelBase
{
    ...
    {
        return [
            'codpro' => Yii::t('base_names', 'Code'),
            'despro' => Yii::t('base_names', 'Description'),
            'rucpro' => Yii::t('base_names', 'Record Vendor'),
            'telpro' => Yii::t('base_names', 'Phone Number'),
            'web' => Yii::t('base_names', 'web'),
            'deslarga' => Yii::t('base_names', 'Long Text'),
        ];
    }
