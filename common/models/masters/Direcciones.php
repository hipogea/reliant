...
class Direcciones extends \common\models\base\modelBase
{
    ...
    public function attributeLabels()
    {
        return [
            ...
            'direc' => Yii::t('base_names', 'Address'),
            'nomlug' => Yii::t('base_names', 'Place Name'),
            'distrito' => Yii::t('base_names', 'District'),
            'provincia' => Yii::t('base_names', 'Province'),
            'departamento' => Yii::t('base_names', 'Departament'),
            'latitud' => Yii::t('base_names', 'Latitude'),
            'meridiano' => Yii::t('base_names', 'Meridian'),
            'codpro' => Yii::t('base_names', 'Vendor Code'),
        ];
    }
